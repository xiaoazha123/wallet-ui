    ...
    <div className="content-padded" style={{paddingTop:'0'}}>
      ...
      <div style={{padding:'0 20px', marginBottom:'24px'}}>
        <div style={{display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'16px'}}>
          <div style={{fontSize:'18px', fontWeight:'800', color:'var(--text-main)'}}>Web3 娱乐中心</div>
          <div style={{fontSize:'12px', color:'var(--primary)', background:'rgba(79, 70, 229, 0.1)', padding:'4px 12px', borderRadius:'20px', fontWeight:'600'}}>Play to Earn</div>
        </div>
